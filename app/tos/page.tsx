...
export default function Terms() {
  return (
    <Container size="lg" className="space-y-6 py-8">
      ...
      <P>
        Imagenation allows users to upload, share, and download royalty-free images. You may use the images available on Imagenation for personal and commercial purposes, subject to these Terms and any applicable license agreements. You are responsible for your use of the Service and any content you submit, including compliance with all applicable laws and regulations.
      </P>

      <H2>2. User Accounts</H2>
      <P>
        To upload content or access certain features, you may be required to create an account. You agree to provide accurate and complete information during the registration process and to keep your account information updated. You are solely responsible for safeguarding your password and for all activity that occurs under your account.
      </P>

      <H2>3. Intellectual Property Rights</H2>
      <P>
        All content on Imagenation, including images, text, graphics, and logos, is owned by Imagenation or its contributors and is protected by intellectual property laws. Images uploaded by users remain the property of their respective owners, but by uploading, you grant Imagenation a worldwide, royalty-free license to display, distribute, and promote your content within the platform.
      </P>

      <H2>4. Uploading Content</H2>
      <P>
        By uploading content, you affirm that you have the necessary rights to distribute such content and that it does not violate any law or third-party rights, including copyright, trademark, or privacy rights. You must not upload any content that is pornographic, violent, hateful, discriminatory, or otherwise inappropriate.
      </P>
